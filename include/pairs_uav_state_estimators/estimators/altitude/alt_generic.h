...
#include <pairs_uav_state_estimators/AltitudeEstimatorConfig.h>
...
class AltGeneric : public AltitudeEstimator<alt_generic::n_states> {
  ...
  typedef pairs_lib::DynamicReconfigureMgr<AltitudeEstimatorConfig> drmgr_t;

  using lkf_t         = pairs_lib::LKF<alt_generic::n_states, alt_generic::n_inputs, alt_generic::n_measurements>;
  using varstep_lkf_t = pairs_lib::varstepLKF<alt_generic::n_states, alt_generic::n_inputs, alt_generic::n_measurements>;
  using A_t           = lkf_t::A_t;
  using B_t           = lkf_t::B_t;
  using H_t           = lkf_t::H_t;
  using Q_t           = lkf_t::Q_t;
