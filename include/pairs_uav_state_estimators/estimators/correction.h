...
#include <pairs_msgs/EstimatorCorrection.h>
...
#include <pairs_uav_state_estimators/CorrectionConfig.h>
...
public:
  ...
  typedef pairs_lib::DynamicReconfigureMgr<CorrectionConfig> drmgr_t;
...
private:
  ...
  pairs_lib::SubscribeHandler<geometry_msgs::PoseStamped> sh_pose_s_;
  ...
  pairs_lib::SubscribeHandler<geometry_msgs::PoseWithCovarianceStamped> sh_pose_wcs_;

  pairs_lib::SubscribeHandler<pairs_msgs::RtkGps> sh_rtk_;
  void                                        callbackRtk(const pairs_msgs::RtkGps::ConstPtr msg);
  std::optional<measurement_t>                getCorrectionFromRtk(const pairs_msgs::RtkGpsConstPtr msg);

  pairs_lib::SubscribeHandler<sensor_msgs::NavSatFix> sh_navsatfix_;
  ...
  pairs_lib::SubscribeHandler<geometry_msgs::PointStamped> sh_point_;
  ...
  pairs_lib::SubscribeHandler<geometry_msgs::Vector3Stamped> sh_vector_;
  ...
  pairs_lib::SubscribeHandler<geometry_msgs::QuaternionStamped> sh_orientation_;  // for obtaining heading rate
  std::string                                                 orientation_topic_;

  pairs_lib::SubscribeHandler<geometry_msgs::QuaternionStamped> sh_quat_;
  ...
  pairs_lib::SubscribeHandler<pairs_msgs::Float64Stamped> sh_mag_hdg_;
  std::optional<measurement_t>                        getCorrectionFromMagHeading(const pairs_msgs::Float64StampedConstPtr msg);
  void                                                callbackMagHeading(const pairs_msgs::Float64Stamped::ConstPtr msg);
  double                                              mag_hdg_previous_;
  bool                                                got_first_mag_hdg_;

  pairs_lib::SubscribeHandler<sensor_msgs::MagneticField> sh_mag_field_;
  ...
  pairs_lib::PublisherHandler<pairs_msgs::EstimatorCorrection> ph_correction_raw_;
  pairs_lib::PublisherHandler<pairs_msgs::EstimatorCorrection> ph_correction_proc_;
  pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>      ph_delay_;
  pairs_lib::PublisherHandler<geometry_msgs::PointStamped>   ph_mag_field_untilted_;
  ...
  void publishCorrection(const MeasurementStamped& measurement_stamped, pairs_lib::PublisherHandler<pairs_msgs::EstimatorCorrection>& ph_corr);
...
Correction<n_measurements>::Correction(ros::NodeHandle& nh, const std::string& est_name, const std::string& name, const std::string& ns_frame_id,
  ...
  switch (msg_type_) {
    case MessageType_t::ODOMETRY: {
      sh_odom_ = pairs_lib::SubscribeHandler<nav_msgs::Odometry>(shopts, msg_topic_, &Correction::callbackOdometry, this);
      break;
    }
    case MessageType_t::POSE: {
      sh_pose_s_ = pairs_lib::SubscribeHandler<geometry_msgs::PoseStamped>(shopts, msg_topic_, &Correction::callbackPoseStamped, this);
      break;
    }
    case MessageType_t::POSECOV: {
      // TODO implement
      /* sh_pose_wcs_ = pairs_lib::SubscribeHandler<geometry_msgs::PoseWithCovarianceStamped>(shopts, msg_topic_); */
      break;
    }
    case MessageType_t::RANGE: {
      sh_range_                   = pairs_lib::SubscribeHandler<sensor_msgs::Range>(shopts, msg_topic_, &Correction::callbackRange, this);
    ...
    case MessageType_t::IMU: {
      sh_imu_ = pairs_lib::SubscribeHandler<sensor_msgs::Imu>(shopts, msg_topic_, &Correction::callbackImu, this);
      break;
    }
    case MessageType_t::RTK_GPS: {
      sh_rtk_ = pairs_lib::SubscribeHandler<pairs_msgs::RtkGps>(shopts, msg_topic_, &Correction::callbackRtk, this);
      break;
    }
    case MessageType_t::NAVSATFIX: {
      sh_navsatfix_ = pairs_lib::SubscribeHandler<sensor_msgs::NavSatFix>(shopts, msg_topic_, &Correction::callbackNavSatFix, this);
      break;
    }
    case MessageType_t::MAG_HDG: {
      sh_mag_hdg_ = pairs_lib::SubscribeHandler<pairs_msgs::Float64Stamped>(shopts, msg_topic_, &Correction::callbackMagHeading, this);
      break;
    }
    case MessageType_t::MAG_FIELD: {
      sh_mag_field_ = pairs_lib::SubscribeHandler<sensor_msgs::MagneticField>(shopts, msg_topic_, &Correction::callbackMagField, this);
      ph_mag_field_untilted_ = pairs_lib::PublisherHandler<geometry_msgs::PointStamped>(nh, est_name_ + "/correction/" + getName() + "/fcu_untilted", 10);

      break;
    }
    case MessageType_t::POINT: {
      sh_point_ = pairs_lib::SubscribeHandler<geometry_msgs::PointStamped>(shopts, msg_topic_, &Correction::callbackPoint, this);
      break;
    }
    case MessageType_t::VECTOR: {
      sh_vector_ = pairs_lib::SubscribeHandler<geometry_msgs::Vector3Stamped>(shopts, msg_topic_, &Correction::callbackVector, this);
      break;
    }
    case MessageType_t::QUAT: {
      sh_quat_ = pairs_lib::SubscribeHandler<geometry_msgs::QuaternionStamped>(shopts, msg_topic_);
      break;
    }
  ...
  /*   sh_orientation_    = pairs_lib::SubscribeHandler<geometry_msgs::QuaternionStamped>(shopts, orientation_topic_); */
  /* } */
  ...
  if (ch_->debug_topics.correction) {
    ph_correction_raw_  = pairs_lib::PublisherHandler<pairs_msgs::EstimatorCorrection>(nh, est_name_ + "/correction/" + getName() + "/raw", 10);
    ph_correction_proc_ = pairs_lib::PublisherHandler<pairs_msgs::EstimatorCorrection>(nh, est_name_ + "/correction/" + getName() + "/proc", 10);
  }
  if (ch_->debug_topics.corr_delay) {
    ph_delay_ = pairs_lib::PublisherHandler<pairs_msgs::Float64Stamped>(nh, est_name_ + "/correction/" + getName() + "/delay", 10);
  }
          ...
          try {
            ...
            if (got_first_hdg_measurement_) {
              measurement(StateId_t::POSITION) =
                  pairs_lib::geometry::radians::unwrap(measurement(StateId_t::POSITION), prev_hdg_measurement_(StateId_t::POSITION));
            } else {
...
/*//{ callbackRtk() */
template <int n_measurements>
void Correction<n_measurements>::callbackRtk(const pairs_msgs::RtkGps::ConstPtr msg) {
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t> Correction<n_measurements>::getCorrectionFromRtk(const pairs_msgs::RtkGpsConstPtr msg) {
  ...
  if (msg->fix_type.fix_type != pairs_msgs::RtkFixType::RTK_FIX) {
...
/*//{ callbackMagHeading() */
template <int n_measurements>
void Correction<n_measurements>::callbackMagHeading(const pairs_msgs::Float64Stamped::ConstPtr msg) {
...
std::optional<typename Correction<n_measurements>::measurement_t> Correction<n_measurements>::getCorrectionFromMagHeading(
    const pairs_msgs::Float64StampedConstPtr msg) {
...
std::optional<typename Correction<n_measurements>::measurement_t> Correction<n_measurements>::getCorrectionFromMagField(
  ...
  switch (est_type_) {
    ...
    case EstimatorType_t::HEADING: {
      ...
      /* pairs_msgs::Float64Stamped hdg_stamped; */
...
bool Correction<n_measurements>::isMsgComing() {
  ...
  const ros::Time msg_time = pairs_lib::get_mutexed(mtx_msg_time_, msg_time_);
...
void Correction<n_measurements>::publishCorrection(const MeasurementStamped&                                 measurement_stamped,
                                                   pairs_lib::PublisherHandler<pairs_msgs::EstimatorCorrection>& ph_corr) {

  if (!ch_->debug_topics.correction) {
    return;
  }

  pairs_msgs::EstimatorCorrection msg;
