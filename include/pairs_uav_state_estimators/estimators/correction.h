...
#include <pairs_msgs/msg/estimator_correction.hpp>
...
const std::map<std::string, MessageType_t> map_msg_type{{"nav_msgs/Odometry", MessageType_t::ODOMETRY},
                                                        ...
                                                        {"pairs_msgs/RtkGps", MessageType_t::RTK_GPS},
                                                        {"sensor_msgs/NavSatFix", MessageType_t::NAVSATFIX},
                                                        {"pairs_msgs/Float64Stamped", MessageType_t::MAG_HDG},
...
class Correction {
  ...
  using StateId_t         = pairs_uav_managers::estimation_manager::StateId_t;
...
public:
  Correction(const rclcpp::Node::SharedPtr &node, const std::string &est_name, const std::string &name, const std::string &frame_id,
             ...
             pairs_lib::errorgraph::ErrorPublisher *error_publisher);

  std::string                    getName() const;
  std::string                    getNamespacedName() const;
  std::string                    getPrintName() const;
  pairs_lib::errorgraph::node_id_t getSourceNodeId() const;
...
private:
  ...
  pairs_lib::SubscriberHandler<geometry_msgs::msg::PoseStamped> sh_pose_s_;
  ...
  pairs_lib::SubscriberHandler<geometry_msgs::msg::PoseWithCovarianceStamped> sh_pose_wcs_;

  pairs_lib::SubscriberHandler<pairs_msgs::msg::RtkGps> sh_rtk_;
  void                                              callbackRtk(const pairs_msgs::msg::RtkGps::ConstSharedPtr msg);
  std::optional<measurement_t>                      getCorrectionFromRtk(const pairs_msgs::msg::RtkGps::ConstSharedPtr msg);

  pairs_lib::SubscriberHandler<sensor_msgs::msg::NavSatFix> sh_navsatfix_;
  ...
  pairs_lib::SubscriberHandler<geometry_msgs::msg::PointStamped> sh_point_;
  ...
  pairs_lib::SubscriberHandler<geometry_msgs::msg::Vector3Stamped> sh_vector_;
  ...
  pairs_lib::SubscriberHandler<geometry_msgs::msg::QuaternionStamped> sh_orientation_; // for obtaining heading rate
  std::string                                                       orientation_topic_;

  pairs_lib::SubscriberHandler<geometry_msgs::msg::QuaternionStamped> sh_quat_;
  ...
  pairs_lib::SubscriberHandler<pairs_msgs::msg::Float64Stamped> sh_mag_hdg_;
  std::optional<measurement_t>                              getCorrectionFromMagHeading(const pairs_msgs::msg::Float64Stamped::ConstSharedPtr msg);
  void                                                      callbackMagHeading(const pairs_msgs::msg::Float64Stamped::ConstSharedPtr msg);
  double                                                    mag_hdg_previous_;
  bool                                                      got_first_mag_hdg_;

  pairs_lib::SubscriberHandler<sensor_msgs::msg::MagneticField> sh_mag_field_;
  ...
  pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool> ss_toggle_range_;
  ...
  pairs_lib::PublisherHandler<pairs_msgs::msg::EstimatorCorrection> ph_correction_raw_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::EstimatorCorrection> ph_correction_proc_;
  pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>      ph_delay_;
  pairs_lib::PublisherHandler<geometry_msgs::msg::PointStamped>   ph_mag_field_untilted_;
  ...
  enum class error_type_t : uint16_t
  {
    ...
    no_rtk_correction,
    no_navsatfix_msgs,
    no_navsatfix_correction,
    nan_correction,
  };

  // non-owning pointer, hence don't manage lifetime (DO NOT DELETE)
  pairs_lib::errorgraph::ErrorPublisher *error_pub_ptr;
  pairs_lib::errorgraph::node_id_t       source_node_id_;

  void publishCorrection(const MeasurementStamped &measurement_stamped, pairs_lib::PublisherHandler<pairs_msgs::msg::EstimatorCorrection> &ph_corr);
...
Correction<n_measurements>::Correction(const rclcpp::Node::SharedPtr &node, const std::string &est_name, const std::string &name,
  ...
  if (map_msg_type.find(msg_type_string) == map_msg_type.end()) {
    RCLCPP_ERROR(this->node_->get_logger(), "[%s]: wrong message type: %s of correction %s", getPrintName().c_str(), msg_type_string.c_str(),
                 getName().c_str());
    error_pub_ptr->addOneshotError("Wrong correction message type");
    error_pub_ptr->flushAndShutdown();
  }
  ...
  if (state_id_tmp < n_StateId_t) {
    ...
    error_pub_ptr->addOneshotError("Wrong state ID of correction");
    error_pub_ptr->flushAndShutdown();
  }
  ...
  dynparam_mgr_->register_param(node_->get_sub_namespace() + "/noise", &drs_params_.sensor_noise, drs_params_.sensor_noise,
                                pairs_lib::DynparamMgr::range_t<double>(0.0, 100000.0));
  ...
  case MessageType_t::ODOMETRY: {
    sh_odom_ = pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry>(shopts, msg_topic_, &Correction::callbackOdometry, this);
    break;
  }
  case MessageType_t::POSE: {
    sh_pose_s_ = pairs_lib::SubscriberHandler<geometry_msgs::msg::PoseStamped>(shopts, msg_topic_, &Correction::callbackPoseStamped, this);
    break;
  }
  case MessageType_t::POSECOV: {
    // TODO implement
    /* sh_pose_wcs_ = pairs_lib::SubscriberHandler<geometry_msgs::msg::PoseWithCovarianceStamped>(shopts, msg_topic_); */
    break;
  }
  case MessageType_t::RANGE: {

    sh_range_ = pairs_lib::SubscriberHandler<sensor_msgs::msg::Range>(shopts, msg_topic_, &Correction::callbackRange, this);

    ss_toggle_range_ = pairs_lib::ServiceServerHandler<std_srvs::srv::SetBool>(
  ...
  case MessageType_t::IMU: {
    sh_imu_ = pairs_lib::SubscriberHandler<sensor_msgs::msg::Imu>(shopts, msg_topic_, &Correction::callbackImu, this);
    break;
  }
  case MessageType_t::RTK_GPS: {
    sh_rtk_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::RtkGps>(shopts, msg_topic_, &Correction::callbackRtk, this);
    break;
  }
  case MessageType_t::NAVSATFIX: {
    sh_navsatfix_ = pairs_lib::SubscriberHandler<sensor_msgs::msg::NavSatFix>(shopts, msg_topic_, &Correction::callbackNavSatFix, this);
    break;
  }
  case MessageType_t::MAG_HDG: {
    sh_mag_hdg_ = pairs_lib::SubscriberHandler<pairs_msgs::msg::Float64Stamped>(shopts, msg_topic_, &Correction::callbackMagHeading, this);
    break;
  }
  case MessageType_t::MAG_FIELD: {
    sh_mag_field_ = pairs_lib::SubscriberHandler<sensor_msgs::msg::MagneticField>(shopts, msg_topic_, &Correction::callbackMagField, this);
    ph_mag_field_untilted_ =
        pairs_lib::PublisherHandler<geometry_msgs::msg::PointStamped>(node_, "~/" + est_name_ + "/correction/" + getName() + "/fcu_untilted");

    break;
  }
  case MessageType_t::POINT: {
    sh_point_ = pairs_lib::SubscriberHandler<geometry_msgs::msg::PointStamped>(shopts, msg_topic_, &Correction::callbackPoint, this);
    break;
  }
  case MessageType_t::VECTOR: {
    sh_vector_ = pairs_lib::SubscriberHandler<geometry_msgs::msg::Vector3Stamped>(shopts, msg_topic_, &Correction::callbackVector, this);
    break;
  }
  case MessageType_t::QUAT: {
    sh_quat_ = pairs_lib::SubscriberHandler<geometry_msgs::msg::QuaternionStamped>(shopts, msg_topic_);
    break;
  }
  ...
  /*   sh_orientation_    = pairs_lib::SubscriberHandler<geometry_msgs::msg::QuaternionStamped>(shopts, orientation_topic_); */
  /* } */
  ...
  if (ch_->debug_topics.correction) {
    ph_correction_raw_  = pairs_lib::PublisherHandler<pairs_msgs::msg::EstimatorCorrection>(node_, "~/" + est_name_ + "/correction/" + getName() + "/raw");
    ph_correction_proc_ = pairs_lib::PublisherHandler<pairs_msgs::msg::EstimatorCorrection>(node, "~/" + est_name_ + "/correction/" + getName() + "/proc");
  }

  if (ch_->debug_topics.corr_delay) {
    ph_delay_ = pairs_lib::PublisherHandler<pairs_msgs::msg::Float64Stamped>(node_, "~/" + est_name_ + "/correction/" + getName() + "/delay");
  }
...
/*//{ getSourceNodeId() */
template <int n_measurements>
pairs_lib::errorgraph::node_id_t Correction<n_measurements>::getSourceNodeId() const {
...
} // namespace pairs_uav_state_estimation
/*//}*/
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromOdometry(const nav_msgs::msg::Odometry::ConstSharedPtr msg) {
  ...
  case EstimatorType_t::HEADING: {
    ...
    case StateId_t::POSITION: {
      measurement_t                               measurement;
      std::unique_ptr<pairs_lib::AttitudeConverter> attitude;
      ...
      if (transform_to_frame_enabled_) {
        ...
        // R_to_from = R^to_from
        Eigen::Matrix3d R_to_from = pairs_lib::AttitudeConverter(res.value().transform.rotation);

        Eigen::Matrix3d R_odom = pairs_lib::AttitudeConverter(msg->pose.pose.orientation);

        // obtain heading from orientation
        attitude = std::make_unique<pairs_lib::AttitudeConverter>(R_to_from * R_odom);

      } else {
        attitude = std::make_unique<pairs_lib::AttitudeConverter>(msg->pose.pose.orientation);
      }
      ...
      try {
        ...
        if (got_first_hdg_measurement_) {
          measurement(StateId_t::POSITION) = pairs_lib::geometry::radians::unwrap(measurement(StateId_t::POSITION), prev_hdg_measurement_(StateId_t::POSITION));
        } else {
      ...
      /*   try { */
      /*     measurement_t measurement; */
      /*     measurement(0) = pairs_lib::AttitudeConverter(msg->pose.pose.orientation).getHeadingRate(msg->twist.twist.angular); */
      /*     return measurement; */
      /*   } */
      /*   catch (...) { */
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromPoseStamped(const geometry_msgs::msg::PoseStamped::ConstSharedPtr msg) {
  ...
  case EstimatorType_t::HEADING: {
    ...
    case StateId_t::POSITION: {
      ...
      try {
        // obtain heading from orientation
        measurement(StateId_t::POSITION) = pairs_lib::AttitudeConverter(msg->pose.orientation).getHeading();
        // unwrap heading wrt previous measurement
        if (got_first_hdg_measurement_) {
          measurement(StateId_t::POSITION) = pairs_lib::geometry::radians::unwrap(measurement(POSITION), prev_hdg_measurement_(POSITION));
        } else {
          got_first_hdg_measurement_ = true;
        }
        prev_hdg_measurement_ = measurement;
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromRange(const sensor_msgs::msg::Range::ConstSharedPtr msg) {
  ...
  range_point.pose.orientation = pairs_lib::AttitudeConverter(0, 0, 0);
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromImu(const sensor_msgs::msg::Imu::ConstSharedPtr msg) {
  ...
  case EstimatorType_t::HEADING: {
    ...
    case StateId_t::VELOCITY: {
      ...
      measurement_t measurement;
      measurement(0) = pairs_lib::AttitudeConverter(orientation).getHeadingRate(msg->angular_velocity);
      return measurement;
      break;
    }
...
/*//{ callbackRtk() */
template <int n_measurements>
void Correction<n_measurements>::callbackRtk(const pairs_msgs::msg::RtkGps::ConstSharedPtr msg) {
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromRtk(const pairs_msgs::msg::RtkGps::ConstSharedPtr msg) {
  ...
  if (msg->fix_type.fix_type != pairs_msgs::msg::RtkFixType::RTK_FIX) {
  ...
  pairs_lib::UTM(msg->gps.latitude, msg->gps.longitude, &rtk_pos.pose.position.x, &rtk_pos.pose.position.y);
  rtk_pos.pose.position.z  = msg->gps.altitude;
  rtk_pos.pose.orientation = pairs_lib::AttitudeConverter(0, 0, 0);
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromNavSatFix(const sensor_msgs::msg::NavSatFix::ConstSharedPtr msg) {
  ...
  pairs_lib::UTM(msg->latitude, msg->longitude, &navsatfix_pos.point.x, &navsatfix_pos.point.y);
...
/*//{ callbackMagHeading() */
template <int n_measurements>
void Correction<n_measurements>::callbackMagHeading(const pairs_msgs::msg::Float64Stamped::ConstSharedPtr msg) {
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromMagHeading(const pairs_msgs::msg::Float64Stamped::ConstSharedPtr msg) {
  ...
  case EstimatorType_t::HEADING: {
    ...
    measurement(0)    = -pairs_lib::geometry::radians::unwrap(mag_hdg, mag_hdg_previous_) + M_PI / 2; // may be weirdness of px4 heading (NED vs ENU or something)
    mag_hdg_previous_ = mag_hdg;
    return measurement;
  }
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromMagField(const sensor_msgs::msg::MagneticField::ConstSharedPtr msg) {
  ...
  case EstimatorType_t::HEADING: {
    ...
    /* if (res) { */
    /*   rot = Eigen::Matrix3d(pairs_lib::AttitudeConverter(res.value().transform.rotation)); */
    /* } else { */
    ...
    /* pairs_msgs::msg::Float64Stamped hdg_stamped; */
    ...
    measurement(0)    = -pairs_lib::geometry::radians::unwrap(mag_hdg, mag_hdg_previous_); // may be weirdness of px4 heading (NED vs ENU or something)
    mag_hdg_previous_ = mag_hdg;
    return measurement;
  }
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromPoint(const geometry_msgs::msg::PointStamped::ConstSharedPtr msg) {
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromVector(const geometry_msgs::msg::Vector3Stamped::ConstSharedPtr msg) {
  ...
  case EstimatorType_t::HEADING: {
    ...
    case StateId_t::VELOCITY: {
      try {
        ...
        measurement_t measurement;
        measurement(0) = pairs_lib::AttitudeConverter(sh_orientation_.getMsg()->quaternion).getHeadingRate(msg->vector);
        return measurement;
      }
      catch (...) {
...
template <int n_measurements>
std::optional<typename Correction<n_measurements>::measurement_t>
Correction<n_measurements>::getCorrectionFromQuat([[maybe_unused]] const geometry_msgs::msg::QuaternionStamped::ConstSharedPtr msg) {
...
bool Correction<n_measurements>::isMsgComing() {
  ...
  const rclcpp::Time msg_time = pairs_lib::get_mutexed(mtx_msg_time_, msg_time_);
...
std::shared_ptr<Processor<n_measurements>> Correction<n_measurements>::createProcessorFromName(const std::string             &name,
  ...
  proc_ph->param_loader   = std::make_unique<pairs_lib::ParamLoader>(subnode);
...
void Correction<n_measurements>::publishCorrection(const MeasurementStamped                                      &measurement_stamped,
                                                   pairs_lib::PublisherHandler<pairs_msgs::msg::EstimatorCorrection> &ph_corr) {

  if (!ch_->debug_topics.correction) {
    return;
  }

  pairs_msgs::msg::EstimatorCorrection msg;
...
void Correction<n_measurements>::publishDelay(const double delay) {
  ...
  pairs_msgs::msg::Float64Stamped msg;
