...
#include <pairs_uav_state_estimators/HeadingEstimatorConfig.h>
...
class HdgGeneric : public HeadingEstimator<hdg_generic::n_states> {
  ...
  typedef pairs_lib::DynamicReconfigureMgr<HeadingEstimatorConfig> drmgr_t;

  using lkf_t         = pairs_lib::LKF<hdg_generic::n_states, hdg_generic::n_inputs, hdg_generic::n_measurements>;
  using varstep_lkf_t = pairs_lib::varstepLKF<hdg_generic::n_states, hdg_generic::n_inputs, hdg_generic::n_measurements>;
  using A_t           = lkf_t::A_t;
  using B_t           = lkf_t::B_t;
  using H_t           = lkf_t::H_t;
  using Q_t           = lkf_t::Q_t;
