...
#include <pairs_uav_state_estimators/LateralEstimatorConfig.h>
...
class LatGeneric : public LateralEstimator<lat_generic::n_states> {
  ...
  typedef pairs_lib::DynamicReconfigureMgr<LateralEstimatorConfig> drmgr_t;

  using lkf_t         = pairs_lib::LKF<lat_generic::n_states, lat_generic::n_inputs, lat_generic::n_measurements>;
  using varstep_lkf_t = pairs_lib::varstepLKF<lat_generic::n_states, lat_generic::n_inputs, lat_generic::n_measurements>;
  using A_t           = lkf_t::A_t;
  using B_t           = lkf_t::B_t;
  using H_t           = lkf_t::H_t;
  using Q_t           = lkf_t::Q_t;
  ...
  typedef pairs_lib::Repredictor<varstep_lkf_t> rep_lkf_t;
...
private:
  ...
  pairs_lib::SubscribeHandler<pairs_msgs::EstimatorInput> sh_control_input_;
  ...
  pairs_lib::SubscribeHandler<pairs_msgs::EstimatorOutput> sh_hdg_state_;
