...
#include <pairs_msgs/msg/estimator_output.hpp>
...
class PartialEstimator : public pairs_uav_managers::Estimator {
...
protected:
  mutable pairs_lib::PublisherHandler<pairs_msgs::msg::EstimatorOutput>     ph_output_;
  mutable pairs_lib::PublisherHandler<pairs_msgs::msg::Float64ArrayStamped> ph_input_;
...
void PartialEstimator<n_states, n_axes>::publishOutput() const {
  ...
  pairs_msgs::msg::EstimatorOutput msg;
...
void PartialEstimator<n_states, n_axes>::publishInput(const u_t &u, const rclcpp::Time &stamp) const {
  ...
  pairs_msgs::msg::Float64ArrayStamped msg;
