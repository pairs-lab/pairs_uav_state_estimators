...
#include <pairs_msgs/EstimatorOutput.h>
...
protected:
  mutable pairs_lib::PublisherHandler<pairs_msgs::EstimatorOutput>     ph_output_;
  mutable pairs_lib::PublisherHandler<pairs_msgs::Float64ArrayStamped> ph_input_;
...
void PartialEstimator<n_states, n_axes>::publishOutput() const {
  ...
  pairs_msgs::EstimatorOutput msg;
...
void PartialEstimator<n_states, n_axes>::publishInput(const u_t &u, const ros::Time& stamp) const {
  ...
  pairs_msgs::Float64ArrayStamped msg;
