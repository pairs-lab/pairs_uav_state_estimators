...
private:
  ...
  pairs_lib::SubscribeHandler<geometry_msgs::QuaternionStamped> sh_orientation_;
};
...
ProcExcessiveTilt<n_measurements>::ProcExcessiveTilt(ros::NodeHandle& nh, const std::string& correction_name, const std::string& name,
  ...
  sh_orientation_ = pairs_lib::SubscribeHandler<geometry_msgs::QuaternionStamped>(shopts, "/" + ch->uav_name + "/" + orientation_topic_);
}
/*//}*/
