...
private:
  ...
  pairs_lib::SubscriberHandler<sensor_msgs::msg::NavSatFix> sh_gnss_;
...
ProcMagDeclination<n_measurements>::ProcMagDeclination(const rclcpp::Node::SharedPtr &node, const std::string &correction_name, const std::string &name,
  ...
  sh_gnss_ = pairs_lib::SubscriberHandler<sensor_msgs::msg::NavSatFix>(shopts, gnss_topic_, &ProcMagDeclination::callbackGnss, this);
