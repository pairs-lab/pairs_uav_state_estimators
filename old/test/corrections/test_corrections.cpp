...
int correctionTfTestImpl(const std::vector<double> data_vec) {
  ...
  pairs_uav_state_estimators::Correction<n_measurements> correction(nh, name, "lat_rtk/pos_rtk", "uav1/rtk_origin",
                                                                  pairs_uav_state_estimators::EstimatorType_t::LATERAL, ch);
