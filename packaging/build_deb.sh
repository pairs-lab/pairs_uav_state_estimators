...
# dependency .debs from /prebuilt, then builds pairs_uav_state_estimators and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_uav_state_estimators/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_uav_state_estimators
