...
/*//{ setUavState() */
bool Dummy::setUavState([[maybe_unused]] const pairs_msgs::msg::UavState &uav_state) {
...
PLUGINLIB_EXPORT_CLASS(pairs_uav_state_estimators::dummy::Dummy, pairs_uav_managers::StateEstimator)
