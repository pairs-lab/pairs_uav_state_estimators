...
void GroundTruth::initialize(ros::NodeHandle &nh, const std::shared_ptr<CommonHandlers_t> &ch, const std::shared_ptr<PrivateHandlers_t> &ph) {
  ...
  sh_gt_odom_ = pairs_lib::SubscribeHandler<nav_msgs::Odometry>(shopts, msg_topic_);
...
/*//{ setUavState() */
bool GroundTruth::setUavState([[maybe_unused]] const pairs_msgs::UavState &uav_state) {
