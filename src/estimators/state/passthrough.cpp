...
void Passthrough::initialize(ros::NodeHandle &parent_nh, const std::shared_ptr<CommonHandlers_t> &ch, const std::shared_ptr<PrivateHandlers_t> &ph) {
  ...
  sh_passthrough_odom_ = pairs_lib::SubscribeHandler<nav_msgs::Odometry>(shopts, msg_topic_, &Passthrough::callbackPassthroughOdom, this);
...
/*//{ setUavState() */
bool Passthrough::setUavState([[maybe_unused]] const pairs_msgs::UavState &uav_state) {
