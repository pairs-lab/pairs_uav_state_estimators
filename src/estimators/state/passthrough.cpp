...
void Passthrough::initialize(const rclcpp::Node::SharedPtr &node, const std::shared_ptr<CommonHandlers_t> &ch, const std::shared_ptr<PrivateHandlers_t> &ph) {
  ...
  sh_passthrough_odom_ = pairs_lib::SubscriberHandler<nav_msgs::msg::Odometry>(shopts, msg_topic_, &Passthrough::callbackPassthroughOdom, this);
...
/*//{ setUavState() */
bool Passthrough::setUavState([[maybe_unused]] const pairs_msgs::msg::UavState &uav_state) {
...
PLUGINLIB_EXPORT_CLASS(pairs_uav_state_estimators::passthrough::Passthrough, pairs_uav_managers::StateEstimator)
